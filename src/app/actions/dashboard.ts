...
//   // Add this data mapping payload under your daily fetching route calculations
//   const dailyLimit = 5000 // Can be tied to a structural user metadata setting layer later
//   const todaySpent = snapshot?.todaySpent ?? 0
//   const remaining = dailyLimit - todaySpent
//   const percentageSpent = Math.min((todaySpent / dailyLimit) * 100, 100)
